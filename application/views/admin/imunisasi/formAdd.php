    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form <small>Tambah Data Imunisasi Anak</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                            method="post" action="<?php echo site_url('imunisasi/save'); ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input name="tgl_imunisasi" id="birthday" class="date-picker form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="imunisasi">Jenis Imunisasi
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input name="imunisasi" type="text" id="imunisasi" required="required"
                                        class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="deteksi">Keterangan
                                </label>
                                <div class="col-md-6 col-sm-6 ">
